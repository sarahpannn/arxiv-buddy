...
// Import from global pdfjsLib instead of module for compatibility
const { isValidExplicitDest } = pdfjsLib;
...
window.LinkTarget = LinkTarget;
window.PDFLinkService = PDFLinkService;  
window.SimpleLinkService = SimpleLinkService;
